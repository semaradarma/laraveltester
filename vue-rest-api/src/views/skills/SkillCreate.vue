...
<div class="mt-12">
    <form class="max-w-md mx-auto p-4 bg-white shadow-md rounded-md" @submit.prevent="handleSubmit">
        <div class="space-y-6">
            <div class="mb-6">
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-500">Name</label>
            ...
            <div class="mb-6">
                <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-500">Slug</label>
        ...
        <div class="mt-4">
            <button type="submit" class="px-4 py-2 mt-2 bg-indigo-500 hover:bg-indigo-700 text-white rounded">Store</button>
        </div>
    </form>
</div>
</template>